...
/// </summary>
public class GolfPuttingBodyImageExperiment : Experiment {
    ...
    public GolfPuttingBodyImageExperiment(ExperimentRunner runner, RunnableDesign runnableDesign) : base(runner, runnableDesign) {
