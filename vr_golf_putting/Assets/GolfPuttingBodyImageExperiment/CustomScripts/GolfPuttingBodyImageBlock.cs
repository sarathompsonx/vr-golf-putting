...
/// </summary>
public class GolfPuttingBodyImageBlock : Block {
    ...
    public GolfPuttingBodyImageBlock(ExperimentRunner runner, DataTable trialTable, DataRow data, int index) : base(runner, trialTable, data, index) {
